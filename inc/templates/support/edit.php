<form action="">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <div class="card text-muted text-center bg-light mb-3">
                ...
                <small class="h3">Editar Soporte técnico al equipo</small>
    ...
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <button type="button" class="btn btn-primary btn-lg btn-block" id="btneditSupport"><i class="fas fa-save"></i> Modificar Información</button>
            <br>
