<form action="">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <div class="card text-white text-center bg-dark mb-3">
                ...
                <small class="text-muted h3 text-left" id="accountOwner"></small> 
                </div>
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div class="input-group">
                                ...
                                <input type="hidden" class="form-control" id="ipIDaccount" placeholder="ID correo">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="input-group-prepend">
    ...
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <button type="button" class="btn btn-primary btn-lg btn-block" id="btneditMail"><i class="fas fa-save"></i> Actualizar Información</button>
            <br>
