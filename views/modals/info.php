...
<!-- Large modal -->
<div class="modal fade" id="viewInfo" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<form class="form-horizontal" method="post" action="controlers/dataUpd.php">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Informacion equipo</h5>
								...
								<div class="row">
									<div class="col-6">
									  <div class="form-group">
									    ...
									    <input type="text" class="form-control" name="txtCodeemp" id="txtCodeemp" placeholder="">
									  </div>
									</div>
									<div class="col-6">
									  <div class="form-group">
