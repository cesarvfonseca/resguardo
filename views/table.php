			...
			<table id="example" class="table table-striped" >  
					...
					<tr style="background-color: <?php echo $status_colors[$row ["status"]];?>; color: <?php echo $font_colors[$row ["status"]];?>">
						...
						<td>
							...
							<a href="views/report.php?codeR=<?php echo $row ['code']; ?>" name="create_pdf" class="btn btn-sm btn-success" title="Carta responsiva" target="blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
						</td>
